...
// HOTFIX: Mount analyze route directly to ensure it works
const multer = require('multer');
const upload = multer({ limits: { fileSize: 5 * 1024 * 1024 } });
app.post('/api/grievances/analyze', upload.single('image'), require('./controllers/ticketController').analyzeImage);

app.use('/api/grievances', require('./routes/ticketRoutes')); // Client compatibility
